...
local PerTroopMass = 125
local NoTroops = 6
local NoTroopsSmall = 4
local PerCrateMass = 750
...
my_ctld.smokedistance = UTILS.NMToMeters(3) -- Only smoke or flare zones if requesting player unit is this far away (in meters)
...
my_ctld.droppedbeacontimeout = 7200 -- dropped beacon lasts 120 minutes
...
my_ctld.nobuildmenu = true -- if set to true effectively enforces to have engineers build/repair stuff for you.
...
my_ctld:SetUnitCapabilities("Mi-24P",true,true,2,6,18,1500)
my_ctld:SetUnitCapabilities("Mi-8MT",true,true,2,10,15,1900)
my_ctld:SetUnitCapabilities("UH-60L",true,true,2,10,16,1900)
my_ctld:SetUnitCapabilities("UH-1H",true,true,1,6,15,900)
my_ctld:SetUnitCapabilities("SA342L",false,true,0,4,12,500)
my_ctld:SetUnitCapabilities("SA342M",false,true,0,4,12,500)
...
-- Wheels
my_ctld:AddCratesCargo("Humvee ATGM (1)",{"Humvee ATGM"},CTLD_CARGO.Enum.VEHICLE,1,PerCrateMass,Stock,"ATGM")
my_ctld:AddCratesCargo("Humvee MG (1)",{"Humvee MG"},CTLD_CARGO.Enum.VEHICLE,1,PerCrateMass,Stock,"Rolling")
my_ctld:AddCratesCargo("Linebacker (3)",{"Linebacker"},CTLD_CARGO.Enum.VEHICLE,3,PerCrateMass,Stock,"Rolling")
my_ctld:AddCratesCargo("Bradley (3)",{"Bradley"},CTLD_CARGO.Enum.VEHICLE,3,PerCrateMass,Stock,"ATGM")
my_ctld:AddCratesCargo("ZU-23 Truck (2)",{"ZU-23"},CTLD_CARGO.Enum.VEHICLE,2,PerCrateMass,Stock,"Rolling")
my_ctld:AddCratesCargo("Truck (1)",{"Truck"},CTLD_CARGO.Enum.VEHICLE,1,PerCrateMass,Stock,"Rolling")
my_ctld:AddCratesCargo("Tanker (1)",{"Tanker"},CTLD_CARGO.Enum.VEHICLE,1,PerCrateMass,Stock,"Rolling")
my_ctld:AddCratesCargo("Roland (4)",{"Roland"},CTLD_CARGO.Enum.VEHICLE,4,PerCrateMass,Stock,"Rolling")
my_ctld:AddCratesCargo("Gepard (3)",{"Gepard"},CTLD_CARGO.Enum.VEHICLE,3,PerCrateMass,Stock,"Rolling")
my_ctld:AddCratesCargo("Avenger (2)",{"Avenger"},CTLD_CARGO.Enum.VEHICLE,2,PerCrateMass,Stock,"Rolling")
my_ctld:AddCratesCargo("VAB Mephisto(2)",{"VAB Mephisto"},CTLD_CARGO.Enum.VEHICLE,2,PerCrateMass,Stock,"ATGM")

-- Other/Fixed
my_ctld:AddCratesCargo("Hawk System (8)",{"Blue SAM HAWK"},CTLD_CARGO.Enum.FOB,CratesBig,PerCrateMass,Stock,"Installation")
my_ctld:AddCratesCargo("EWR 117 Radar (6)",{"Blue EWR 117"},CTLD_CARGO.Enum.FOB,6,PerCrateMass,Stock,"Installation")
...
-- Repair
my_ctld:AddCratesRepair("Hawk System (1)",{"Blue SAM HAWK"},CTLD_CARGO.Enum.REPAIR,1,PerCrateMass,Stock,"Repair")
my_ctld:AddCratesRepair("EWR 117 Radar (1)",{"Blue EWR 117"},CTLD_CARGO.Enum.REPAIR,1,PerCrateMass,Stock,"Repair")
