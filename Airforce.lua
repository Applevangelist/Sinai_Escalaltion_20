...
local Zone11Airbase = AIRBASE.Sinai.Ramon_Airbase
local Zone12Airbase = AIRBASE.Sinai.Ovda
local Zone21Airbase = AIRBASE.Sinai.Melez
local Zone22Airbase = AIRBASE.Sinai.Bir_Hasanah
local AwacsAirbase = AIRBASE.Sinai.Melez
...
redcap:AddAirwing(Zone12Airbase,"Ovda AFB")
...
redcap:AddAirwing(AwacsAirbase,"Melez AFB")
...
local alt = math.floor(math.random(18000,30000)/1000)*1000
redcap:AddAirwing(Zone22Airbase,"Bir Hasanah AFB")
